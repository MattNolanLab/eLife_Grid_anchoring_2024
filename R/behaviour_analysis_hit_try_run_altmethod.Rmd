---
title: "Comparing task performance as a function of task-anchored vs task-independent firing using the ensemble classification method"
author: "Harry Clark"
date: "04/04/2023"
...
# set up the formulas
```{r}
formula_full <- formula(p_coding_alt ~ behavioural_outcome + (1 | mouse_id / session_id / cluster_id) + (0 + behavioural_outcome | mouse_id / session_id / cluster_id))
formula_null <- formula(p_coding_alt ~                       (1 | mouse_id / session_id / cluster_id) + (0 + behavioural_outcome | mouse_id / session_id / cluster_id))
```


# run glmer for beaconed trials
```{r}
...
# run glmer for nonbeaconed trials
```{r}
